...
export const headerData: HeaderConfig[] = [
  ...
  },
  {
    ...
    subLinks: [
      ...
      {
        sublinkDisplayName: "KALA BHAVAN",
        sublink: KALABHAVAN_LINK,
      },
    ],
  },
