...
export const ABOUT_IT_LINK = "/about-it-initiatives";
...
export const ABOUT_LOGISTICS_PARA_1 =
...
export const ABOUT_LOGISTICS_PARA_2_CONTENT =
  "for contact details of Counters/Agents. Home delivery facility is available in Hyderabad City.";
export const ABOUT_LOGISTICS_PARA_2 =
  " The consignors can approach the nearest bus station or counter and book their consignment for delivery at their desired location. The consignment will be transported through TGSRTC buses and delivered to the Bus Station/Counter at the destination as desired by the customer. The consignee has to collect the consignment from the Bus Station/Counter. Please visit";
export const ABOUT_TGSRTC_PARAGRAPH =
  " Since its inception in 2014, Telangana State Road Transport Corporation (TGSRTC) TGSRTC has remained committed to excellence in bus transport. Our focus on safety, environmental sustainability, and top-notch service ensures passenger satisfaction and industry leadership.";
...
export const BOOK_YOUR_SERVICE_PARAGRAPH =
...
export const BOOK_YOUR_TICKET_PARAGRAPH =
  "Conveniently book tickets online for a hassle free travel experience.";
export const BOOK_YOUR_TICKET = "Book Your Tickets";
export const BOOK_YOUR_TRAVEL_TICKET =
  "Apply, Renew & Travel effortlessly with TGSRTC";
export const BUS_CONTRACT_RATES = "Bus on Contract Rates";
export const BUS_CONTRACT_RATES_TAGLINE =
  "TGSRTC is happy to announce the following package tours to our valuable commuters at affordable rates.";
export const BUS_DETAILS = "Bus Details";
export const BUS_PASS_FAQ_LINK = "/bus-passes-faqs";
...
export const BUS_PASSES_PARAGRAPH =
  "Dedicated to delivering top-notch services through teamwork, aiming for passenger satisfaction and a leading position in the transport sector. Additionally, TSRTC offers a range of bus passes to cater to various passenger needs. ";
...
export const DETAILS_OF_AIRPORT_PUSHPAK_BUSES =
  "Details of Airport Pushpak bus timings";
...
export const Electric_BUSES_PARA =
  " The following facilities are available in Electric Buses and specially operated to RGI Airport.";
export const Electric_BUSES = "Electric Buses";
export const EMAIL_PLACEHOLDER = "Enter your email here...";
export const EMAIL_TYPE = "email";
export const EMAIL_REQ_FIELD = "Email is required"
export const EMAIL = "Email";
export const ERR_REQ_MSG = "Error submitting form. Please check your connection."
export const ERR_MSG = "Error submitting the form. Please try again."
export const ERROR_MSG_NAME = "Name is required";
export const ERROR_MSG_EMAIL_REQ = "Email is required"
export const ERROR_MSG_EMAIL = "Invalid email address";
export const EVENTS_AWARDS = "Events & Awards";
export const FACEBOOK_URL = "https://www.facebook.com/TGSRTCHQ";
...
export const GAMAYAM_APP_PARAGRAPH =
  "Experience seamless travel with TGSRTC's innovative TGSRTC Gamyam mobile app, offering real-time tracking for all buses. With this convenient feature, passengers can effortlessly monitor the status of all bus services, ensuring a smooth and stress-free journey";
export const GARUDA_PLUS_HEADING = "Garuda Plus (Multi Axle A.C)";
export const GARUDA_PLUS_PARA =
  "The Corporation has earmarked seats in buses for ladies, physically challenged, MLAs/MPs, Senior Citizens, Presidents of Mandal Parishads & ZPTC members etc. The layout diagrams of each type of bus are shown here.";
...
export const GOOGLE_PLAY_STORE_URL =
  "https://play.google.com/store/apps/details?id=com.tsrtc";
export const GUIDING_PRINCIPLE = "Guiding Principles of TGSRTC";
export const HERO_TITLE = "TGSRTC serving people since 1932";
export const HIRE_BUS =
  "https://www.tgsrtcbus.in/bus-hire.html";
export const HIRE_BUS_PARAGRAPH =
  "TGSRTC offers bus rental services for weddings, events, and special occasions at competitive rates. Opt for their chartered service for a safe and enjoyable journey.";
export const HOME = "Home";
export const HOSPITAL_LINK = "/tarnaka-hospital";
export const TARNAKA_HOSPITAL_LINK = 'https://tgsrtchospital.com/';
export const TGSRTC_HOSPITAL_SERVICES = 'https://tgsrtchospital.com/';
export const HOSPITAL_STANDS =
...
export const HOME_BOOK_YOUR_TICKET = "https://www.tgsrtcbus.in/oprs-web/";
...
export const HYDERABAD_THIRD_PARAGRAPH =
  "Choose TGSRTC Make Hyderabad to Yadadri journey safe, secure and simple";
export const INDIA_GOVT_URL = "https://www.india.gov.in/";
export const INFORMATION = "Information";
export const INSTAGRAM_URL =
  "https://www.instagram.com/tgsrtchq/?utm_medium=copy_link";
...
export const VISIT_TO_THE_SITE_LABEL = "Visit to the site";
...
export const LOGISTICS_LINK = "/logistics-Book-your-cargo";
...
export const METRO_DELUX_COACH_PARA =
  "Metro Deluxe Coaches with better features like attractive colour scheme, seat comfort, wider windows etc., are introduced in place of Metro liners for the benefit of long distance city commuters.";
export const METRO_DELUX_COACH =
  "Metro Deluxe coach for twin cities of Hyderabad and Secunderabad";
...
export const MUNCHINTALA_FIRST_PARAGRAPH =
  "Muchintala village in Ranga Reddy district is now an international destination. Taking forward Sri Ramanuja’s ideals and philosophy, Sri Chinna Jeeyar Swamy has dreamt of a larger-than-life statue, the statue of equality, and a vast campus of worship for pilgrims. To help people reach the destination, TGSRTC has arranged special buses to the statue of equality and has prepared a schedule for statue of equality bus timings.";
export const MUNCHINTALA_SECOND_PARAGRAPH =
  "Muchintala bus timings are convenient and available. Now, the journey to Muchintala is easy and simple with TGSRTCFor TGSRTC buses to Muchintala refer to the below schedule. Have a safe and secure journey with TGSRTC";
export const NAME_PLACEHOLDER = "Enter your name here...";
export const NAME = "Name";
export const NAME_REQ = "Name is required";
export const NEWS_UPDATES = "News & Updates";
export const NEWS_UPDATES_CARD_CONTENT =
  "Lorem ipsum dolor sit amet, adipiscing elit. sed do eiusmod temporincididunt ut. adipiscing elit. sed do eiusmod tempor incididunt ut.";
...
export const OTHER_BUS_PASSES_PARA =
...
export const PACKAGE_TOUR_WILL =
  "Package tour will be starting from alpha hotel sec-bad @08:30am and take you to birla mandir, golkonda fort, taramati baradari,where you can have lunch {at your own cost} chowmahala palace, charminar, lumbini park & back to alpha hotel.";
export const PHONE_NO = "Phone No.";
export const PHONE_NO_REQ = "Phone number is required";
export const PHONE_NO_REQ_LENGTH = "Phone number must have 10 digits"
export const PHONE_NO_VALID = "Invalid phone number";
...
export const PUSHPAK_AIRPORT_LINERS =
  "Pushpak Airport Liner bus point controllers and contact numbers";
export const QUICKLINKS = "Quick Links";
export const RAJDHANI_HEADING = "Rajadhani A / C Buses";
export const RAJDHANI_PARA =
  "To provide a comfortable A C buses at affordable fare, TGSRTC introduced 12 m A/C buses under brand name 'Rajadhani' with an intermediary fare between Super Luxury and Garuda plus.";
export const RATES_TABLE1_TITLE =
  "Pickup and Drop upto 200 kms contract (One way)";
export const RATES_TABLE2_TITLE =
  "Bus on Contract (200 Kms Minimum)(District Services)";
export const RATES_TABLE3_TITLE =
  "Hire Charges for City Services (City Ordinary, Metro Express & Metro Deluxe services)(SLAB RATES)";
...
export const RESERVATION_POINTS1 = "Ticket Booking Agents";
export const RESERVATIONS = "Reservations";
export const RESERVATIONS_BUS_LINK = "/reservation-coach-types";
// changed name consession schemes to marketing schemes 
export const RESERVATIONS_MARKETING_LINK = "/reservation-marketing-schemes";
export const RESERVATIONS_CONTRACT_LINK = "/reservation-contract-rates";
export const RESERVATIONS_FAQ_LINK = "/reservation-faqs";
export const KALABHAVAN_LINK = "/kala-bhavan";
export const RESERVATIONS_LINK = "/reservation-booking-service-home";
export const RESERVATIONS_POINTS_LINK = "/ticket-booking-agents";
export const RESERVATIONS_KALABHAVAN_BOOKING = "KalaBhavan Booking";
export const AIRPORT_TIMINGS = "Airport Timings";
export const RESERVATIONS_KALABHAVAN_BOOKING_LINK = "https://tgsrtcstrpcms.telangana.gov.in/uploads/kalabhavan_details_convert_pdf_1_4e42d55d3a.pdf";
...
export const SUGGESTIONS_MSG = 'Suggestions are required'
...
export const SUGGESTIONS_REQ_MSG = "Suggestions are required"
export const SEAT_LAYOUT_OF_TGSRTC_PARA =
...
export const SUCCESS_MSG = "Form submitted successfully!"
export const SENIOR_CITIZENS = "Senior citizens";
export const HOSPITAL_WEBSITE = "Hospital Website";
...
export const SUPER_LUXURY_PARA =
  "The following facilities are available in Super Luxury Coaches:";
export const T20_TICKET =
  " T-24 ticket can be purchased at any time from any city bus conductor and is valid for next 24 hrs from the date and time of purchase of the ticket";
...
export const TELEPHONE_TYPE = "number";
...
export const TGSRTC_STALL_LINK = ""
export const TGSRTC_ADVERTISEMENT_LINK = ""
...
export const TOURISM_OFFER_LINE =
  "TGSRTC is happy to announce the following package tours to our valuable commuters at affordable rates.";
...
export const TRAVEL_ACROSS_TG =
  "Travel across Telangana on our TGSRTC buses and explore tourist places.";
export const TRAVEL_EFFORTLESSLY =
  "Apply, Renew & Travel effortlessly with TGSRTC";
export const TRAVEL = "Travel-24(T-24) Tickets";
export const TWITTER_URL = "https://x.com/TGSRTCHQ";
...
export const WARNING_MSG = "Please fill in all required fields."
